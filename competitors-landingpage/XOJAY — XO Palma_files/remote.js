...
J:"ytp-mdx-popup-dialog",D:{role:"dialog"},T:[{U:"div",J:"ytp-mdx-popup-dialog-inner-content",T:[{U:"div",J:"ytp-mdx-popup-title",G0:"Du bist nicht angemeldet"},{U:"div",J:"ytp-mdx-popup-description",G0:"Videos, die du dir ansiehst, werden m\u00f6glicherweise zum TV-Wiedergabeverlauf hinzugef\u00fcgt und k\u00f6nnen sich damit auf deine TV-Empfehlungen auswirken. Melde dich auf einem Computer in YouTube an, um das zu vermeiden."},{U:"div",J:"ytp-mdx-privacy-popup-buttons",T:[{U:"button",UR:["ytp-button",
"ytp-mdx-privacy-popup-cancel"],G0:"Abbrechen"},{U:"button",UR:["ytp-button","ytp-mdx-privacy-popup-confirm"],G0:"Best\u00e4tigen"}]}]}]});this.fade=new g.Jd(this,250);this.cancelButton=this.Vc("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Vc("ytp-mdx-privacy-popup-confirm");g.Q(this,this.fade);this.K(this.cancelButton,"click",this.X);this.K(this.confirmButton,"click",this.B)},jN=function(m){g.d.call(this,{U:"div",
J:"ytp-remote",T:[{U:"div",J:"ytp-remote-display-status",T:[{U:"div",J:"ytp-remote-display-status-icon",T:[g.kRB()]},{U:"div",J:"ytp-remote-display-status-text",G0:"{{statustext}}"}]}]});this.api=m;this.fade=new g.Jd(this,250);g.Q(this,this.fade);this.K(m,"presentingplayerstatechange",this.onStateChange);this.UM(m.getPlayerStateObject())},In=function(m,F){g.p9.call(this,"Wiedergeben auf",1,m,F);
...
this.yP={key:hgC(),name:"Dieser Computer"};this.r9=null;this.subscriptions=[];this.YJ=this.PR=null;this.Al=[this.yP];this.HC=this.yP;this.wF=new g.aQ(64);this.u8=0;this.yg=-1;this.v3=!1;this.gs=this.VS=this.Bx=null;if(!g.Hs(this.player.C())&&!g.Z9(this.player.C())){m=this.player;var F=g.x5(m);F&&(F=F.eb())&&(F=new In(m,F),g.Q(this,F));F=new jN(m);g.Q(this,F);g.Jb(m,F.element,4);this.Bx=new Vd;g.Q(this,this.Bx);g.Jb(m,this.Bx.element,4);this.v3=!!LL()}},Rn=function(m){m.VS&&(m.player.removeEventListener("presentingplayerstatechange",
...
jN.prototype.UM=function(m){if(this.api.getPresentingPlayerType()===3){var F={RECEIVER_NAME:this.api.getOption("remote","currentReceiver").name};m=g.n(m,128)?g.L8("Fehler auf $RECEIVER_NAME",F):m.isPlaying()||m.isPaused()?g.L8("Wiedergabe \u00fcber $RECEIVER_NAME",F):g.L8("Verbunden mit $RECEIVER_NAME",F);this.updateValue("statustext",m);this.fade.show()}else this.fade.hide()};g.Y(In,g.p9);In.prototype.B=function(){var m=this.j.getOption("remote","receivers");m&&m.length>1&&!this.j.getOption("remote","quickCast")?(this.Al=g.P5(m,this.X,this),this.fK(g.xZ(m,this.X)),m=this.j.getOption("remote","currentReceiver"),m=this.X(m),this.options[m]&&this.Kj(m),this.enable(!0)):this.enable(!1)};
In.prototype.X=function(m){return m.key};
In.prototype.Om=function(m){return m==="cast-selector-receiver"?"Streamen\u2026":this.Al[m].name};
